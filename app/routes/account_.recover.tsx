      ...
      <div className="relative h-full">
        <div className="center w-full max-w-[450px] bg-cream px-7 py-10 rounded-lg account">
          {action?.resetRequested ? (
            <>
              <h6 className="text-center hidden md:block">Request Sent.</h6>
              <h4 className="text-center block md:hidden">Request Sent.</h4>
            ...
            <>
              <h6 className="text-center hidden md:block">
                Forgot yout password?
              </h6>
              <h4 className="text-center md:hidden">Forgot yout password?</h4>
